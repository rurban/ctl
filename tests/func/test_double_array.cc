...
#define GENERATE_NAME(x) #x,
        ...
        case TEST_FIND: {
            const size_t index = TEST_RAND(N);
            int value = TEST_RAND(2) ? rand() * 1.0 : *arr20_double_at(&a, index);
            double key = value;
        ...
        case TEST_FIND_IF_NOT_RANGE: {
            ...
            std::array<double, 20>::iterator first_b, last_b;
            get_random_iters(&a, &first_a, b, first_b, last_b);
            arr20_double_it i = arr20_double_find_if_not_range(&first_a, double_is_odd);
        ...
        case TEST_ALL_OF_RANGE: {
            ...
            std::array<double, 20>::iterator first_b, last_b;
            get_random_iters(&a, &first_a, b, first_b, last_b);
            bool aa = arr20_double_all_of_range(&first_a, double_is_odd);
        ...
        case TEST_NONE_OF_RANGE: {
            ...
            std::array<double, 20>::iterator first_b, last_b;
            get_random_iters(&a, &first_a, b, first_b, last_b);
            bool aa = arr20_double_none_of_range(&first_a, double_is_odd);
        ...
        case TEST_COUNT_IF_RANGE: {
            ...
            std::array<double, 20>::iterator first_b, last_b;
            get_random_iters(&a, &first_a, b, first_b, last_b);
            size_t numa = arr20_double_count_if_range(&first_a, double_is_odd);
        ...
        case TEST_ANY_OF_RANGE: {
            ...
            std::array<double, 20>::iterator first_b, last_b;
            get_random_iters(&a, &first_a, b, first_b, last_b);
            bool aa = arr20_double_any_of_range(&first_a, double_is_odd);
