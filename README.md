...
| [ctl/bvector.h](docs/bvector.md)               | packed boolean vector | bvec     |
...
| [ctl/swisstable.h](docs/swisstable.md)         | open-addressing map  | swiss_TK_T        |
| [ctl/hashmap.h](docs/hashmap.md)               | auto-hashed open-addressing map | hmap_TK_T |
| [ctl/flat_set.h](docs/flat_set.md)             | std::flat_set        | fset (C++23)     |
| [ctl/flat_multiset.h](docs/flat_multiset.md)   | std::flat_multiset   | fmset (C++23)    |
| [ctl/flat_map.h](docs/flat_map.md)             | std::flat_map        | fmap (C++23)     |
| [ctl/flat_multimap.h](docs/flat_multimap.md)   | std::flat_multimap   | fmmap (C++23)    |
| [ctl/inplace_vector.h](docs/inplace_vector.md) | std::inplace_vector  | inplace_vecN (C++26) |
| [ctl/hive.h](docs/hive.md)                     | std::hive            | hive (C++26)     |
| [ctl/span.h](docs/span.md)                     | std::span            | span     |
| [ctl/strv.h](docs/strv.md)                     | std::string_view     | strv     |
|------------------------------------------------|----------------------|
...
|                                 |vec  |str  |arr  |deq  |list |slst |pqu  |que  |stk  |bvec |btst |span |strv |ivec |hive |
|---------------------------------|---- |---- |---- |---- |---- |---- |---- |---- |---- |---- |---- |---- |---- |---- |---- |
|`adjacent_find`                  | ✓   | ✓   | ✓   | ✓   | ✓   | ✓   |     |     |     |     |     |     |     |     |     |
|`adjacent_find_range`            | ✓   | ✓   | ✓   | ✓   | ✓   | ✓   |     |     |     |     |     |     |     |     |     |
|`advance`                        | ✓   | ✓   | ✓   | ✓   | ✓   | ✓   |     |     |     |     |     |     |     | x   |     |
...
|                                 |set  |map  |uset |umap |fset |fmap |swiss |hmap |
|---------------------------------|---- |---- |---- |---- |---- |---- |----- |---- |
|`adjacent_find`                  | ✓   |     |     |     |     |     |      |     |
|`adjacent_find_range`            | ✓   |     |     |     |     |     |      |     |
|`advance`                        | ✓   | ✓   | -   | -   |     |     | -    | -   |
...
Added lots of missing methods. We have 254 methods in 1045 stable variants.
